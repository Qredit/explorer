export default {
  TokenDetails: "QSLP Token Details",
  TokenId: "Token ID",
  TokenSymbol: "Token Symbol",
  TokenName: "Token Name",
  TokenTransactionType: "Transaction Method",
  ...
  TokenGenesisTime: "Genesis Timestamp",
  TokenDocumentUri: "Document URI",
  TokenDecimals: "Decimal Places",
  TokenGenesisQty: "Genesis Quantity",
  Statistics: "Statistics",
  TokenBlockCreated: "Created at Block ID",
  TokenBlockHeightCreated: "Created at Block Height",
  TokenBlockHeightLastUpdate: "Block Height Last Update",
  TokenBlockLastActiveSend: "Block Height Last Send",
  TokenBlockLastActiveMint: "Block Height Last Mint",
  TokenValidTxnsSinceGenesis: "Total Valid Transactions",
  TokenValidTokenAddresses: "Total Valid Addresses",
  TokenQtyMinted: "Total Minted",
  TokenQtyBurned: "Total Burned",
  TokenQtyCirculatingSupply: "Total Circulating Supply",
