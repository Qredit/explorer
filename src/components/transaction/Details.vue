  ...
  <div>
    <section class="page-section py-5 md:py-10 mb-5">
      ...
      <div v-if="transaction.tokenData" class="px-5 sm:px-10">
        ...
        <div v-if="transaction.tokenData.valid == false" class="list-row-border-b">
          <div>{{ $t("TokenInvalidReason") }}</div>
          <div>{{ transaction.tokenData.invalidReason }}</div>
        </div>

        <div v-if="transaction.tokenData.transactionDetails.genesisOrMintQuantity != 0" class="list-row-border-b">
